...
public class PacketScan {
    ...
    public static Message packetScan(byte[] buffer, int start, int dataLength, int mask, Packet packet) {
        return packetScan(buffer, start, dataLength, mask, packet, false);
    }

    public static Message packetScan(byte[] buffer, int start, int dataLength, int mask, Packet packet, boolean debug) {
